...
import "./chunk-KMOCP5OR.js";
import {
  ownerWindow
} from "./chunk-LT53RE6M.js";
import "./chunk-3JOA4H7Q.js";
import "./chunk-CASRHNSY.js";
import {
...
import "./chunk-ZJC27A2C.js";
import "./chunk-NYHBQTAG.js";
import "./chunk-ITGWAFDM.js";
import "./chunk-2DISYFAT.js";
import "./chunk-SCNNAZ2S.js";
import {
  useTheme
} from "./chunk-3EHVV4O3.js";
import "./chunk-JCURTG5I.js";
import {
  _extends,
  clsx_default,
  composeClasses,
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      var React75 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim.useSyncExternalStore, useRef11 = React75.useRef, useEffect15 = React75.useEffect, useMemo13 = React75.useMemo, useDebugValue = React75.useDebugValue;
...
function ChartsTooltipContainer(inProps) {
  ...
  const popperRef = React44.useRef(null);
  ...
  const anchorEl = React44.useMemo(() => ({
  ...
  const modifiers = React44.useMemo(() => [
    {
      name: "offset",
      options: {
        offset: () => {
...
var consumeSlots = (name, slotPropName, options, InComponent) => {
  ...
  return React46.forwardRef(ConsumeSlotsInternal);
};
...
}, React48.forwardRef(function ChartsLegend2(props, ref) {
...
function ChartsYHighlight(props) {
  ...
  return (0, import_jsx_runtime29.jsxs)(React52.Fragment, {
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime31.jsxs)(React54.Fragment, {
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime35.jsx)(React58.Fragment, {
    children: xTicks.map(({
      value,
      offset
    }) => {
...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime36.jsx)(React59.Fragment, {
    children: yTicks.map(({
      value,
      offset
    }) => {
...
var useLineChartProps = (props) => {
  ...
  const seriesWithDefault = React64.useMemo(() => series.map((s2) => _extends({
...
var useChartVoronoi = ({
  ...
  const voronoiRef = React65.useRef({});
  const delauneyRef = React65.useRef(void 0);
  const lastFind = React65.useRef(void 0);
  const defaultXAxisId = xAxisIds[0];
  const defaultYAxisId = yAxisIds[0];
  useEnhancedEffect_default(() => {
...
var ChartsSlotsContext = React66.createContext(null);
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime43.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime43.jsxs)(React68.Fragment, {
...
var ChartsSurface = React72.forwardRef(function ChartsSurface2(inProps, ref) {
  const store = useStore();
  const {
    width: svgWidth,
    height: svgHeight
...
var LineChart = React74.forwardRef(function LineChart2(inProps, ref) {
  var _a, _b, _c, _d;
  const props = useThemeProps({
    props: inProps,
    name: "MuiLineChart"
