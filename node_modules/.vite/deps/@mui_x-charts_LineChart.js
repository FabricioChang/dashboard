import {
  ...
  require_shim,
  warnOnce
} from "./chunk-2C7WPKAW.js";
import {
  useMediaQuery_default
} from "./chunk-2VXMVIRT.js";
import {
  HTMLElementType,
  useSlotProps_default
} from "./chunk-FU3FIBKK.js";
import {
  Typography_default
} from "./chunk-W44BITSL.js";
import {
  useThemeProps
} from "./chunk-LNHFONBS.js";
import {
  IconButton_default
} from "./chunk-6BTTAPWQ.js";
import {
  ownerWindow
} from "./chunk-OJBD5MUB.js";
import "./chunk-ELRGLCXO.js";
import "./chunk-7RD3ORVH.js";
import "./chunk-L3JFJR3S.js";
import {
  _objectWithoutPropertiesLoose,
  useEventCallback_default,
  useForkRef,
  useLazyRef
} from "./chunk-2LIY2KLP.js";
import "./chunk-67VZ3QMQ.js";
import "./chunk-OO7MCVEX.js";
import "./chunk-NB46BLB6.js";
import "./chunk-Q6YJHUAD.js";
import "./chunk-3OKMVPY6.js";
import "./chunk-IFWWLZWH.js";
import "./chunk-UEPRMOFC.js";
import {
  useTheme
} from "./chunk-67FIERQC.js";
import {
  composeClasses,
  exactProp,
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      var React76 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim.useSyncExternalStore, useRef11 = React76.useRef, useEffect16 = React76.useEffect, useMemo13 = React76.useMemo, useDebugValue = React76.useDebugValue;
...
var PointerGesture = class extends Gesture {
  ...
  getRelevantPointers(pointers, calculatedTarget) {
    return pointers.filter((pointer) => calculatedTarget === pointer.target || calculatedTarget.contains(pointer.target) || pointer.target === this.originalTarget || calculatedTarget === this.originalTarget);
  }
  destroy() {
...
function calculateCentroid(pointers) {
  ...
  const sum4 = pointers.reduce((acc, pointer) => {
  ...
  return {
    x: sum4.x / pointers.length,
    y: sum4.y / pointers.length
  };
}
...
var useChartInteractionListener = ({
  ...
  const addInteractionListener = React5.useCallback((interaction, callback, options) => {
    const svg = svgRef.current;
...
var CHART_CORE_PLUGINS = [useChartId, useChartDimensions, useChartSeries, useChartInteractionListener, useChartAnimation];
...
function computeAxisValue({
  ...
  allAxis.forEach((eachAxis, axisIndex) => {
    ...
    completeAxis[axis.id] = _extends({
      ...
      valueFormatter: axis.valueFormatter ?? createScalarFormatter(tickNumber, getScale(scaleType, range2.map((v2) => scale2.invert(v2)), range2))
    });
  });
  return {
    axis: completeAxis,
...
var useInteractionItemProps = (data, skip) => {
  ...
  const onPointerEnter = React13.useCallback(() => {
  ...
  const onPointerLeave = React13.useCallback(() => {
...
function computeAxisValue2({
  ...
  allAxis.forEach((eachAxis, axisIndex) => {
    ...
    if (isBandScaleConfig(axis)) {
      ...
      if (isDateData(axis.data)) {
        const dateFormatter = createDateFormatter(axis, range2);
        completeAxis[axis.id].valueFormatter = axis.valueFormatter ?? dateFormatter;
      }
    }
    if (isPointScaleConfig(axis)) {
...
var ChartsLocalizationContext = React17.createContext(null);
...
function ChartsLocalizationProvider(inProps) {
  ...
  } = React17.useContext(ChartsLocalizationContext) ?? {
    localeText: void 0
  };
  ...
  const localeText = React17.useMemo(() => _extends({}, DEFAULT_LOCALE, themeLocaleText, parentLocaleText, inLocaleText), [themeLocaleText, parentLocaleText, inLocaleText]);
...
var useChartsLocalization = () => {
  const localization = React18.useContext(ChartsLocalizationContext);
...
function AppearingMask(props) {
  ...
  return (0, import_jsx_runtime3.jsxs)(React19.Fragment, {
...
var AnimatedLine = React24.forwardRef(function AnimatedLine2(props, ref) {
  const {
    skipAnimation,
    ownerState
      ...
      return groupIds.map((seriesId) => {
        ...
        return (0, import_jsx_runtime12.jsx)("g", {
          ...
          children: xData == null ? void 0 : xData.map((x2, index2) => {
            ...
            if (!instance.isPointInside(x2, y2)) {
              return false;
            }
            if (showMark === true) {
              return true;
...
function useIsHydrated() {
  const [isHydrated, setIsHydrated] = React31.useState(typeof window !== "undefined" || false);
  React31.useEffect(() => {
    setIsHydrated(true);
  }, []);
  return isHydrated;
    ...
    for (let i = 0; i < ticks2.length; i += 1) {
      ...
      if (isInside) {
        visibleTicks.push({
          ...
          labelOffset: tickLabelPlacement === "middle" ? scale2(ticks2[i - 1] ?? 0) - (offset + scale2(ticks2[i - 1] ?? 0)) / 2 : 0
        });
      }
    }
    return visibleTicks;
...
function ChartsText(props) {
  ...
  const wordsByLines = React33.useMemo(() => getWordsByLines({
    style,
  ...
  return (0, import_jsx_runtime13.jsx)("text", _extends({}, textProps, {
    ...
    dominantBaseline,
    style,
    children: wordsByLines.map((line, index2) => (0, import_jsx_runtime13.jsx)("tspan", {
      x: x2,
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime16.jsxs)(React37.Fragment, {
...
var consumeThemeProps = (name, options, InComponent) => React38.forwardRef(function ConsumeThemeInternal(props, ref) {
  var _a;
  const themedProps = useThemeProps({
    props,
  ...
  const OutComponent = React38.forwardRef(InComponent);
...
function useColorProcessor(seriesType) {
  const store = useStore();
  const seriesConfig5 = useSelector(store, selectorChartSeriesConfig);
  const colorProcessors = React41.useMemo(() => {
    const rep = {};
...
function usePointerType() {
  ...
  const [pointerType, setPointerType] = React42.useState(null);
  React42.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function ChartsTooltipContainer(inProps) {
  ...
  const anchorEl = React45.useMemo(() => ({
  ...
  const modifiers = React45.useMemo(() => [
    {
      name: "offset",
      options: {
        offset: () => {
...
var consumeSlots = (name, slotPropName, options, InComponent) => {
  ...
  return React47.forwardRef(ConsumeSlotsInternal);
};
...
}, React49.forwardRef(function ChartsLegend2(props, ref) {
...
true ? ChartsLabelGradient.propTypes = {
   ...
   * @default 'horizontal'
   */
  direction: import_prop_types23.default.oneOf(["vertical", "horizontal"]),
  /**
   * A unique identifier for the gradient.
   * The `gradientId` will be used as `fill="url(#gradientId)"`.
   */
  gradientId: import_prop_types23.default.string.isRequired,
  /**
   ...
   */
  rotate: import_prop_types23.default.bool,
  /**
...
var ContinuousColorLegend = consumeThemeProps("MuiContinuousColorLegend", {
  ...
  return (0, import_jsx_runtime27.jsxs)(RootElement2, _extends({
    ...
    ownerState: props,
    children: [reverse2 ? maxComponent : minComponent, (0, import_jsx_runtime27.jsx)("li", {
...
true ? ContinuousColorLegend.propTypes = {
   ...
   */
  gradientId: import_prop_types24.default.string,
  /**
   ...
   */
  maxLabel: import_prop_types24.default.oneOfType([import_prop_types24.default.func, import_prop_types24.default.string]),
  /**
   * The label to display at the minimum side of the gradient.
   * Can either be a string, or a function.
   * @default formattedValue
   */
  minLabel: import_prop_types24.default.oneOfType([import_prop_types24.default.func, import_prop_types24.default.string]),
  /**
   ...
   * Useful for linear gradients that are not in the correct orientation.
   */
  rotateGradient: import_prop_types24.default.bool,
  /**
   * The thickness of the gradient
   * @default 12
   */
...
true ? PiecewiseColorLegend.propTypes = {
   ...
   */
  labelFormatter: import_prop_types25.default.func,
  /**
   * Where to position the labels relative to the gradient.
   * @default 'extremes'
   */
   ...
   * @default 'square'
   */
  markType: import_prop_types25.default.oneOf(["square", "circle", "line"]),
  /**
   * Callback fired when a legend item is clicked.
   * @param {React.MouseEvent<HTMLButtonElement, MouseEvent>} event The click event.
...
function ChartsXHighlight(props) {
  ...
  return (0, import_jsx_runtime30.jsxs)(React54.Fragment, {
...
true ? LineHighlightElement.propTypes = {
  ...
  shape: import_prop_types28.default.oneOf(["circle", "cross", "diamond", "square", "star", "triangle", "wye"]).isRequired
} : void 0;
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime35.jsx)(React59.Fragment, {
    children: xTicks.map(({
      value,
      offset
    }) => {
...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime36.jsx)(React60.Fragment, {
    children: yTicks.map(({
      value,
      offset
    }) => {
...
var useLineChartProps = (props) => {
  ...
  const seriesWithDefault = React65.useMemo(() => series.map((s2) => _extends({
...
var useChartVoronoi = ({
  ...
  const voronoiRef = React66.useRef({});
  const delauneyRef = React66.useRef(void 0);
  const lastFind = React66.useRef(void 0);
  const defaultXAxisId = xAxisIds[0];
  const defaultYAxisId = yAxisIds[0];
  useEnhancedEffect_default(() => {
...
var ChartsSlotsContext = React67.createContext(null);
...
true ? ChartDataProvider.propTypes = {
  ...
  apiRef: import_prop_types31.default.shape({
    current: import_prop_types31.default.any
  }),
  /**
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime43.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime43.jsxs)(React69.Fragment, {
  ...
  return (0, import_jsx_runtime46.jsxs)("defs", {
    children: [filteredYAxisIds.map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime46.jsxs)(React72.Fragment, {
...
var ChartsSurface = React73.forwardRef(function ChartsSurface2(inProps, ref) {
  const store = useStore();
  const {
    width: svgWidth,
    height: svgHeight
...
var getDirection3 = (direction, position) => {
...
var LineChart = React75.forwardRef(function LineChart2(inProps, ref) {
  var _a, _b, _c, _d;
  const props = useThemeProps({
    props: inProps,
    name: "MuiLineChart"
...
true ? LineChart.propTypes = {
   ...
   * @default { x: 'line' }
   */
  axisHighlight: import_prop_types33.default.shape({
    x: import_prop_types33.default.oneOf(["band", "line", "none"]),
    y: import_prop_types33.default.oneOf(["band", "line", "none"])
  }),
   ...
   * @default rainbowSurgePalette
   */
  colors: import_prop_types33.default.oneOfType([import_prop_types33.default.arrayOf(import_prop_types33.default.string), import_prop_types33.default.func]),
  /**
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
  dataset: import_prop_types33.default.arrayOf(import_prop_types33.default.object),
  desc: import_prop_types33.default.string,
  /**
   * If `true`, the charts will not listen to the mouse move event.
   * It might break interactive features, but will improve performance.
   * @default false
   */
  disableAxisListener: import_prop_types33.default.bool,
  /**
   * If `true`, render the line highlight item.
   */
  disableLineItemHighlight: import_prop_types33.default.bool,
  /**
   * Option to display a cartesian grid in the background.
   */
  grid: import_prop_types33.default.shape({
    horizontal: import_prop_types33.default.bool,
    vertical: import_prop_types33.default.bool
  }),
  /**
   * The height of the chart in px. If not defined, it takes the height of the parent element.
   */
  height: import_prop_types33.default.number,
  /**
   * If `true`, the legend is not rendered.
   */
  hideLegend: import_prop_types33.default.bool,
  /**
   * The highlighted item.
   * Used when the highlight is controlled.
   */
  highlightedItem: import_prop_types33.default.shape({
    dataIndex: import_prop_types33.default.number,
    seriesId: import_prop_types33.default.oneOfType([import_prop_types33.default.number, import_prop_types33.default.string]).isRequired
  }),
  /**
   * This prop is used to help implement the accessibility logic.
   * If you don't provide this prop. It falls back to a randomly generated id.
   ...
   * Accepts a `number` to be used on all sides or an object with the optional properties: `top`, `bottom`, `left`, and `right`.
   */
  margin: import_prop_types33.default.oneOfType([import_prop_types33.default.number, import_prop_types33.default.shape({
   ...
   */
  onAreaClick: import_prop_types33.default.func,
  /**
   ...
   */
  onAxisClick: import_prop_types33.default.func,
  /**
   * The callback fired when the highlighted item changes.
   *
   * @param {HighlightItemData | null} highlightedItem  The newly highlighted item.
   */
  onHighlightChange: import_prop_types33.default.func,
  /**
   * Callback fired when a line element is clicked.
   */
  onLineClick: import_prop_types33.default.func,
  /**
   * Callback fired when a mark element is clicked.
   */
  onMarkClick: import_prop_types33.default.func,
  /**
   * The series to display in the line chart.
   * An array of [[LineSeriesType]] objects.
   */
  series: import_prop_types33.default.arrayOf(import_prop_types33.default.object).isRequired,
  /**
  ...
  theme: import_prop_types33.default.oneOf(["dark", "light"]),
  title: import_prop_types33.default.string,
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
  width: import_prop_types33.default.number,
  /**
   * The configuration of the x-axes.
   * If not provided, a default axis config is used.
   * An array of [[AxisConfig]] objects.
   */
  xAxis: import_prop_types33.default.arrayOf(import_prop_types33.default.oneOfType([import_prop_types33.default.shape({
    axis: import_prop_types33.default.oneOf(["x"]),
    barGapRatio: import_prop_types33.default.number,
    categoryGapRatio: import_prop_types33.default.number,
    classes: import_prop_types33.default.object,
    colorMap: import_prop_types33.default.oneOfType([import_prop_types33.default.shape({
      colors: import_prop_types33.default.arrayOf(import_prop_types33.default.string).isRequired,
      type: import_prop_types33.default.oneOf(["ordinal"]).isRequired,
      unknownColor: import_prop_types33.default.string,
      values: import_prop_types33.default.arrayOf(import_prop_types33.default.oneOfType([import_prop_types33.default.instanceOf(Date), import_prop_types33.default.number, import_prop_types33.default.string]).isRequired)
    }), import_prop_types33.default.shape({
      color: import_prop_types33.default.oneOfType([import_prop_types33.default.arrayOf(import_prop_types33.default.string.isRequired), import_prop_types33.default.func]).isRequired,
      max: import_prop_types33.default.oneOfType([import_prop_types33.default.instanceOf(Date), import_prop_types33.default.number]),
      min: import_prop_types33.default.oneOfType([import_prop_types33.default.instanceOf(Date), import_prop_types33.default.number]),
      type: import_prop_types33.default.oneOf(["continuous"]).isRequired
    }), import_prop_types33.default.shape({
      colors: import_prop_types33.default.arrayOf(import_prop_types33.default.string).isRequired,
      thresholds: import_prop_types33.default.arrayOf(import_prop_types33.default.oneOfType([import_prop_types33.default.instanceOf(Date), import_prop_types33.default.number]).isRequired).isRequired,
      type: import_prop_types33.default.oneOf(["piecewise"]).isRequired
    })]),
    data: import_prop_types33.default.array,
    dataKey: import_prop_types33.default.string,
    disableLine: import_prop_types33.default.bool,
    disableTicks: import_prop_types33.default.bool,
    domainLimit: import_prop_types33.default.oneOfType([import_prop_types33.default.oneOf(["nice", "strict"]), import_prop_types33.default.func]),
    fill: import_prop_types33.default.string,
    height: import_prop_types33.default.number,
    hideTooltip: import_prop_types33.default.bool,
    id: import_prop_types33.default.oneOfType([import_prop_types33.default.number, import_prop_types33.default.string]),
    ignoreTooltip: import_prop_types33.default.bool,
    label: import_prop_types33.default.string,
    labelStyle: import_prop_types33.default.object,
    max: import_prop_types33.default.oneOfType([import_prop_types33.default.instanceOf(Date), import_prop_types33.default.number]),
    min: import_prop_types33.default.oneOfType([import_prop_types33.default.instanceOf(Date), import_prop_types33.default.number]),
    offset: import_prop_types33.default.number,
    position: import_prop_types33.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types33.default.bool,
    scaleType: import_prop_types33.default.oneOf(["band"]),
    slotProps: import_prop_types33.default.object,
    slots: import_prop_types33.default.object,
    stroke: import_prop_types33.default.string,
    sx: import_prop_types33.default.oneOfType([import_prop_types33.default.arrayOf(import_prop_types33.default.oneOfType([import_prop_types33.default.func, import_prop_types33.default.object, import_prop_types33.default.bool])), import_prop_types33.default.func, import_prop_types33.default.object]),
    tickInterval: import_prop_types33.default.oneOfType([import_prop_types33.default.oneOf(["auto"]), import_prop_types33.default.array, import_prop_types33.default.func]),
    tickLabelInterval: import_prop_types33.default.oneOfType([import_prop_types33.default.oneOf(["auto"]), import_prop_types33.default.func]),
    tickLabelMinGap: import_prop_types33.default.number,
    tickLabelPlacement: import_prop_types33.default.oneOf(["middle", "tick"]),
    tickLabelStyle: import_prop_types33.default.object,
    tickMaxStep: import_prop_types33.default.number,
    tickMinStep: import_prop_types33.default.number,
    tickNumber: import_prop_types33.default.number,
    tickPlacement: import_prop_types33.default.oneOf(["end", "extremities", "middle", "start"]),
    tickSize: import_prop_types33.default.number,
    valueFormatter: import_prop_types33.default.func
  }), import_prop_types33.default.shape({
    axis: import_prop_types33.default.oneOf(["x"]),
    classes: import_prop_types33.default.object,
    colorMap: import_prop_types33.default.oneOfType([import_prop_types33.default.shape({
    ...
    position: import_prop_types33.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types33.default.bool,
    scaleType: import_prop_types33.default.oneOf(["point"]),
    slotProps: import_prop_types33.default.object,
    slots: import_prop_types33.default.object,
    stroke: import_prop_types33.default.string,
    sx: import_prop_types33.default.oneOfType([import_prop_types33.default.arrayOf(import_prop_types33.default.oneOfType([import_prop_types33.default.func, import_prop_types33.default.object, import_prop_types33.default.bool])), import_prop_types33.default.func, import_prop_types33.default.object]),
    ...
    position: import_prop_types33.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types33.default.bool,
    scaleType: import_prop_types33.default.oneOf(["log"]),
    slotProps: import_prop_types33.default.object,
    slots: import_prop_types33.default.object,
    stroke: import_prop_types33.default.string,
    sx: import_prop_types33.default.oneOfType([import_prop_types33.default.arrayOf(import_prop_types33.default.oneOfType([import_prop_types33.default.func, import_prop_types33.default.object, import_prop_types33.default.bool])), import_prop_types33.default.func, import_prop_types33.default.object]),
    ...
    position: import_prop_types33.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types33.default.bool,
    scaleType: import_prop_types33.default.oneOf(["pow"]),
    slotProps: import_prop_types33.default.object,
    slots: import_prop_types33.default.object,
    stroke: import_prop_types33.default.string,
    sx: import_prop_types33.default.oneOfType([import_prop_types33.default.arrayOf(import_prop_types33.default.oneOfType([import_prop_types33.default.func, import_prop_types33.default.object, import_prop_types33.default.bool])), import_prop_types33.default.func, import_prop_types33.default.object]),
    ...
    position: import_prop_types33.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types33.default.bool,
    scaleType: import_prop_types33.default.oneOf(["sqrt"]),
    slotProps: import_prop_types33.default.object,
    slots: import_prop_types33.default.object,
    stroke: import_prop_types33.default.string,
    sx: import_prop_types33.default.oneOfType([import_prop_types33.default.arrayOf(import_prop_types33.default.oneOfType([import_prop_types33.default.func, import_prop_types33.default.object, import_prop_types33.default.bool])), import_prop_types33.default.func, import_prop_types33.default.object]),
    ...
    position: import_prop_types33.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types33.default.bool,
    scaleType: import_prop_types33.default.oneOf(["time"]),
    slotProps: import_prop_types33.default.object,
    slots: import_prop_types33.default.object,
    stroke: import_prop_types33.default.string,
    sx: import_prop_types33.default.oneOfType([import_prop_types33.default.arrayOf(import_prop_types33.default.oneOfType([import_prop_types33.default.func, import_prop_types33.default.object, import_prop_types33.default.bool])), import_prop_types33.default.func, import_prop_types33.default.object]),
    ...
    position: import_prop_types33.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types33.default.bool,
    scaleType: import_prop_types33.default.oneOf(["utc"]),
    slotProps: import_prop_types33.default.object,
    slots: import_prop_types33.default.object,
    stroke: import_prop_types33.default.string,
    sx: import_prop_types33.default.oneOfType([import_prop_types33.default.arrayOf(import_prop_types33.default.oneOfType([import_prop_types33.default.func, import_prop_types33.default.object, import_prop_types33.default.bool])), import_prop_types33.default.func, import_prop_types33.default.object]),
    ...
    position: import_prop_types33.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types33.default.bool,
    scaleType: import_prop_types33.default.oneOf(["linear"]),
    slotProps: import_prop_types33.default.object,
    slots: import_prop_types33.default.object,
    stroke: import_prop_types33.default.string,
    sx: import_prop_types33.default.oneOfType([import_prop_types33.default.arrayOf(import_prop_types33.default.oneOfType([import_prop_types33.default.func, import_prop_types33.default.object, import_prop_types33.default.bool])), import_prop_types33.default.func, import_prop_types33.default.object]),
   ...
   * An array of [[AxisConfig]] objects.
   */
  yAxis: import_prop_types33.default.arrayOf(import_prop_types33.default.oneOfType([import_prop_types33.default.shape({
    axis: import_prop_types33.default.oneOf(["y"]),
    barGapRatio: import_prop_types33.default.number,
    categoryGapRatio: import_prop_types33.default.number,
    classes: import_prop_types33.default.object,
    colorMap: import_prop_types33.default.oneOfType([import_prop_types33.default.shape({
    ...
    min: import_prop_types33.default.oneOfType([import_prop_types33.default.instanceOf(Date), import_prop_types33.default.number]),
    offset: import_prop_types33.default.number,
    position: import_prop_types33.default.oneOf(["left", "none", "right"]),
    reverse: import_prop_types33.default.bool,
    scaleType: import_prop_types33.default.oneOf(["band"]),
    slotProps: import_prop_types33.default.object,
    slots: import_prop_types33.default.object,
