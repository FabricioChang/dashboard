...
var PropsContext = React7.createContext(void 0);
...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React12.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: modeStorageKey,
    storageWindow
  }), [storageManager, modeStorageKey, storageWindow]);
  const lightStorage = React12.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: `${colorSchemeStorageKey}-light`,
    storageWindow
  }), [storageManager, colorSchemeStorageKey, storageWindow]);
  const darkStorage = React12.useMemo(() => storageManager == null ? void 0 : storageManager({
  ...
  const [isClient, setIsClient] = React12.useState(noSsr || !isMultiSchemes);
  React12.useEffect(() => {
    setIsClient(true);
  }, []);
...
function createCssVarsProvider(options) {
  ...
  const useColorScheme = () => React13.useContext(ColorSchemeContext) || defaultContext;
  ...
  function CssVarsProvider(props) {
    ...
    const initialTheme = React13.useMemo(() => {
      if (themeProp) {
        return themeProp;
      }
    ...
    const allColorSchemes = React13.useMemo(() => joinedColorSchemes.split(","), [joinedColorSchemes]);
    ...
    const memoTheme = React13.useMemo(() => {
      var _a2;
...
function isMuiElement(element, muiNames) {
  var _a, _b, _c;
  return React15.isValidElement(element) && muiNames.indexOf(
...
function createGrid(options = {}) {
  ...
  const Grid2 = React16.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime11.jsx)(GridRoot, {
      ...
      children: React16.Children.map(children, (child) => {
        var _a;
        if (React16.isValidElement(child) && isMuiElement(child, ["Grid"]) && container && child.props.container) {
...
function joinChildren(children, separator) {
  ...
  return childrenArray.reduce((output, child, index) => {
    ...
    if (index < childrenArray.length - 1) {
      output.push(React17.cloneElement(separator, {
        key: `separator-${index}`
      }));
    }
    return output;
...
function createStack(options = {}) {
  ...
  const Stack2 = React17.forwardRef(function Grid2(inProps, ref) {
    const themeProps = useThemeProps2(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-7JCM5ETH.js.map
